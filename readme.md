...
|-----------------------|--------|---------------|---------------------------|-----------------------|----------|---------------------------|---------------------------------------------------------|
|USB C to A adapter     |1       |22,17          |Blue A to C                |Elough Store/Aliexpress|22,17     |[Link](https://www.aliexpress.com/item/1005008596972414.html)                   |Required as my PC only has USB A and not C               |
